...
//		ul2.appendTo(ul);
	...
	_renderPager: function( ul, records, total ) {
		...
		$("<table cellspacing='0' cellpadding='0' border='0' class='table table-bordered'>"
			+"<tbody>"
				+"<td align='center' style='white-space: pre; width: 564px;' id='cg-keynav-center'>"
...
// Select page
	...
	_renderPagerPage: function (label, page, total){
		...
		if(this.options.i18n){
			...
			return '<small>Page <input type="text" size="1" class="' +self.element.attr('id')+ ' currentPage" value="' + page + '"></input> of ' + total+'</small>';
		}
	},
