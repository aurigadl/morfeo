				...
				<ul class="dropdown-menu">
                    ...
                    if ($usuaPermExpediente || !$numExpediente) {
                        ...
                        <li>
                            ...
                            ?>
                            <a onClick="reportePredios(&quot;<?= $numExpediente ?>&quot;,&quot;<?= $listPredios ?>&quot;,&quot;<?= $vars ?>&quot;,'modeloPredial');">Reporte
                                Inventario de Predios </a>
                        </li>
        ...
        <small>
            ...
            <?php if ($usuaPermExpediente > 1) { ?>
                ...
                <button type='submit' name='savetemasexp_<?= $num_expediente ?>' value="<?= $num_expediente ?>"
                        id="grabadorapidoexpediente" class='btn btn-success  btn-xs'>Grabar ..
                </button>
            <?php } ?>
            <table>
                <?php
