                ...
                <div>
                  <table class="table table-bordered table-striped">
                    ...
                    <tr>
                      <td width="650">
                        <center>
                          <input name="cerrar" type="button" class="btn btn-primary btn-xs" id="envia22" onClick="opener.cargarPagina('expediente/lista_expedientes.php','tabs-a'); window.close();" value=" Cerrar ">
                        </center>
                      </td>
                   </tr>
                 </table>
