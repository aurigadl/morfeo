    ...
    <body style="overflow:hidden; zoom: 1;">
      <div id="wrapper">
        <!-- Sidebar -->
          ...
          <iframe name='mainFrame' frameBorder="0" width="100%" height="95%" src='cuerpo.php?<?=session_name()."=".session_id()?>&swLog=<?=$swLog?>&fechah=<?=$fechah?>&tipo_alerta=1' scrolling='auto'/></iframe>
