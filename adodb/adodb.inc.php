...
if (!$rs){
log_error("ERROR - ADODB adodb/adodb.inc.php","Linea:888 -> Fallo en la funcion create_trail",$query,2);
}
    }
  }
 }
...
function &_Execute($sql,$inputarr=false)
     ...
     $this->create_trail($sql);
		...
		*************************/
		...
		if ($this->_queryID === false) { // error handling if query fails
			log_error("ERROR - ADODB adodb/adodb.inc.php","Linea:896 -> Fallo en la funcion EXECUTE",$sql,2);
	...
	*/
	...
	function Replace($table, $fieldArray, $keyCol, $autoQuote=false, $has_autoinc=false)
	{
		...
		$response = _adodb_replace($this, $table, $fieldArray, $keyCol, $autoQuote, $has_autoinc);
if($response==0){
	log_error("ERROR - ADODB adodb/adodb.inc.php","Linea:1469 -> Fallo en la funcion REPLACE",$fieldArray,1);
}
		return $response;
	}
