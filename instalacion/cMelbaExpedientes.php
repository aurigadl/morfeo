...
$base= "pruebamigracion"; //This would by the Database Name
...
while(!$rs->EOF){
  foreach($rs->fields as $campo=>$valorCampo) {
   ...
   $valorCampo=utf8_encode($valorCampo);
     ...
     $insertSQL = $dbOrfeo->Replace('expedientetemp',$record,array('codigo','dependencia','nombre','descripcion','activo'), $autoquote = true);   
