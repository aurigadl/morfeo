...
CREATE TABLE anexos (
    ...
    anex_depe_codi character varying(10),
...
CREATE TABLE dependencia (
    ...
    dpto_codi numeric(2,0),
    depe_codi_padre numeric(10,0),
    muni_codi numeric(4,0),
    depe_codi_territorial numeric(10,0),
...
CREATE TABLE sgd_agen_agendados (
    ...
    depe_codi character varying(50),
...
INSERT INTO public.sgd_srd_seriesrd(id, sgd_srd_codigo, sgd_srd_descrip, sgd_srd_fechini, sgd_srd_fechfin) VALUES (0, 0, 'No Aplica', '2012-06-06', '2020-06-01');
