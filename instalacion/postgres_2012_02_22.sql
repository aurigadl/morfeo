...
CREATE TABLE sgd_mrd_matrird (
    ...
    sgd_srd_id numeric(4,0) NOT NULL,
    sgd_sbrd_id numeric(4,0) NOT NULL,
...
(
  ...
  CONSTRAINT un_srdId UNIQUE (id) -- Clave unica para codigos de Series.
);
...
(
  ...
  sgd_srd_id bigint DEFAULT 0, -- Codigo unico de serie Documental (id de sgd_srd_seriesrd)
  CONSTRAINT pk_sgd_srd_id FOREIGN KEY (sgd_srd_id)
      REFERENCES sgd_srd_seriesrd (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT uk_sgd_sbrd_subserierd UNIQUE (sgd_srd_codigo, sgd_sbrd_codigo)
);
...
-- Index: fki_pk_sgd_srd_id

-- DROP INDEX fki_pk_sgd_srd_id;

CREATE INDEX fki_pk_sgd_srd_id
  ON sgd_sbrd_subserierd
  USING btree
  (sgd_srd_id);
...
CREATE TABLE SGD_TSOP_TIPOSOPORTE
   (    SGD_TSOP_ID NUMERIC(6,0) DEFAULT NULL NOT NULL ,
        ...
        SGD_TSOP_DEPE_CODI NUMERIC(4,0),
