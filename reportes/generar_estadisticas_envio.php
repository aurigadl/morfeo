...
<div>
    ...
    <div class="widget-body no-padding">
		...
		$rs_reg = $db->conn->Execute($query_t);
                ...
                $campos_vista = array("Cant","Dependencia", "Radicado", "Destinatario", "Direccion", "Municipio", "Departamento", "Fecha de envio", "Forma de envio","Firma");
                $campos_width = array(30,160, 95, 200, 220, 80, 80, 80, 80, 105);
