<?php /* Smarty version 2.6.26, created on 2010-07-12 16:50:07
         compiled from masivaPrestamoRad.tpl */ ?>
...
" 	name="krd">				
		<table width="96%" align="center" margin="4">  
			...
			<tr height="40px">
				...
				<td width="87%">
					<textarea name="radLibre" id="radLibre" readonly="READONLY"  class="select_crearExp nombActuExp"><?php echo $this->_tpl_vars['radLibre']; ?>
</textarea>
				</td>
			</tr>
			...
			<?php if ($this->_tpl_vars['radRestr'] == ''): ?>
			   &nbsp;
			<?php else: ?>
			<tr height="40px">
				...
				<td>
					<textarea readonly="READONLY"  class="select_crearExp nombActuExp" ><?php echo $this->_tpl_vars['radRestr']; ?>
</textarea>					 
				</td>
			</tr>
			<?php endif; ?>
