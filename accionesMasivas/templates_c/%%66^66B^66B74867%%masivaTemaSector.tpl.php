<?php /* Smarty version 2.6.26, created on 2010-07-12 16:53:09
         compiled from masivaTemaSector.tpl */ ?>
			...
			<tr height="40px">
				...
				<td width="87%">
					<select name="selectSector" id="selectSector" class="select_crearExp">								
		                <?php $_from = $this->_tpl_vars['sectorArray']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
							<?php if (sectorArray == $this->_tpl_vars['key']): ?>
...
><?php echo $this->_tpl_vars['item']; ?>
			...
			<?php if ($this->_tpl_vars['radSinSectem'] == ''): ?>
			   &nbsp;
			<?php else: ?>
			<tr height="40px">
		        <td valign="top">Radicados sin <br/>tema-sector :</td>
				<td valign="center" width="100%">
					<textarea id="radSinTemaSec" name="radSinTemaSec" readonly="READONLY"  class="select_crearExp nombActuExp"><?php echo $this->_tpl_vars['radSinSectem']; ?>
</textarea>																					                    
				</td>
		    </tr>
			<?php endif; ?>
			...
			<?php if ($this->_tpl_vars['radConSectem'] == ''): ?>
			   &nbsp;
			<?php else: ?>
			<tr height="40px">
				...
				<td>
					<textarea id="radContemaSec" name="radcontemaSec" readonly="READONLY"  class="select_crearExp nombActuExp"><?php echo $this->_tpl_vars['radConSectem']; ?>
</textarea>
